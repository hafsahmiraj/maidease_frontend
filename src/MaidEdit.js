          ...
          <div className="profile-grid">
            <div className="profile-left">
              ...
              <div className="cnic-images">
                <img
                    src={maid.cnic_photo_front}
                    alt="CNIC Front"
                    className="cnic-img"
                    style={{ maxWidth: "100%", maxHeight: "100%", objectFit: "cover" }}
                />
                <img
                    src={maid.cnic_photo_back}
                    alt="CNIC Back"
                    className="cnic-img"
                    style={{ maxWidth: "100%", maxHeight: "100%", objectFit: "cover" }}
                />
              ...
              {!editing ? (
                  <div className="profile-details">
                    ...
                    <p>
                      ...
                      <span className="profile-value">{maid.contact_number}</span>
                    </p>
                    <p>
                      <strong>CNIC:</strong>
                      <span className="profile-value">{maid.cnic_number}</span>
                    </p>
                    <p>
                      <strong>City:</strong>
                    ...
                    <p>
                      ...
                      <span className="profile-value">{maid.current_address}</span>
                    </p>
                    <p>
                      <strong>State:</strong>
                      <span className="profile-value">{maid.state}</span>
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      <span className="profile-value">{maid.hireCount}</span>
                    </p>
                    <p>
                      <strong>Created At:</strong>
                      <span className="profile-value">
                        {new Date(maid.createdAt).toLocaleString()}
                      </span>
                    </p>
                    <p>
                      <strong>Updated At:</strong>
                      <span className="profile-value">
                        {new Date(maid.updatedAt).toLocaleString()}
                      </span>
                    </p>
                  </div>
              ) : (
