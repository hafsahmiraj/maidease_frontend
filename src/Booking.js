    ...
    const handleSubmit = async () => {
        ...
        try {
            await axios.post('http://localhost:5000/api/maids/hire', {
                maid_id: parseInt(maidId), // Convert maid_id to integer
                house_size: parseInt(houseDetails.house_size), // Convert house_size to integer
                no_of_portions: parseInt(houseDetails.no_of_portions), // Convert no_of_portions to integer
                no_of_peoples: parseInt(houseDetails.no_of_peoples), // Convert no_of_peoples to integer
                hired_skills: selectedSkills, // Pass skills as JSON array
